 ...
 * Kept in sync with src/lib/zurich-holidays.ts (Deno edge runtime — no Luxon).
 */
...
function movableFederalHolidayIsoDates(year: number): string[] {
    ...
    return [
        addDaysIso(easterSunday, -2),
        addDaysIso(easterSunday, 1),
        addDaysIso(easterSunday, 39),
        addDaysIso(easterSunday, 50),
    ];
}
