-- Reconcile friendship interaction tables on remote environments that missed
-- earlier migration(s), then ensure API role visibility.
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.friendship_likes TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.friendship_dislikes TO authenticated;
GRANT ALL ON TABLE public.friendship_likes TO service_role;
GRANT ALL ON TABLE public.friendship_dislikes TO service_role;
