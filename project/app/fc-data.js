...
window.FC = (function () {
  ...
  const circles = [
    ...
    },
    {
      ...
      lastGathering: 'The Sky Deck Lounge · Jun 17', feedbackGiven: false,
    },
    {
  ...
  const events = {
    ...
    circles: [
      { id: 'fdinner', title: "Founders' Dinner", day: 26, month: 'Jun', dow: 'Thu', time: '7:30 PM', loc: 'The Workspace', host: "Founders' Table", attending: 5, cap: 6, interests: ['Startups', 'Investing'], rsvp: false, rating: 4.5, ratings: 9, votes: 8, photo: 'amenity-workspace' },
      { id: 'cmorning', title: 'Coffee Circle Morning', day: 22, month: 'Jun', dow: 'Sun', time: '9:00 AM', loc: 'The Lobby Bar', host: 'Sunday Coffee Circle', attending: 4, cap: 5, interests: ['Coffee', 'Design'], rsvp: false, rating: 4.8, ratings: 14, votes: 12, photo: 'amenity-lobbybar' },
    ],
    resident: [
